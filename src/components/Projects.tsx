  ...
  return (
    <section id="projects" className="w-full mt-2 mb-8 bg-muted/10 dark:bg-gray-900">
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="w-full p-8 rounded-2xl border-4 border-blue-700/10 dark:border-blue-700/20 shadow-lg bg-white dark:bg-gray-800">
          <h2 className="text-4xl font-extrabold mb-12 text-center text-blue-700">Projects</h2>
          <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3 mx-auto justify-items-center">
            {/* Project 1 */}
            <Card className="rounded-2xl shadow-md bg-white dark:bg-gray-800 flex flex-col justify-between h-full relative transition-all duration-300 hover:scale-105 hover:shadow-xl border-4 border-blue-700/10 hover:border-blue-700/30 group">
