  ...
  return (
    <header className="w-full bg-muted/10 dark:bg-gray-900">
      <div className="container mx-auto flex h-20 items-center justify-center px-4">
        <div className="bg-white dark:bg-gray-800 rounded-full shadow-lg border-4 border-blue-700/10 dark:border-blue-700/20 flex items-center px-8 py-2 gap-2 w-[800px]">
          <nav className="flex items-center justify-center w-full mx-auto">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400"
